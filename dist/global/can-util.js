...
/*can-util@3.0.0-pre.15#js/global/global*/
...
/*can-util@3.0.0-pre.15#dom/document/document*/
...
/*can-util@3.0.0-pre.15#dom/data/data*/
...
/*can-util@3.0.0-pre.15#dom/dispatch/dispatch*/
...
/*can-util@3.0.0-pre.15#dom/events/events*/
...
/*can-util@3.0.0-pre.15#dom/mutation-observer/mutation-observer*/
...
/*can-util@3.0.0-pre.15#dom/events/attributes/attributes*/
...
/*can-util@3.0.0-pre.15#dom/attr/attr*/
...
/*can-util@3.0.0-pre.15#dom/child-nodes/child-nodes*/
...
/*can-util@3.0.0-pre.15#dom/class-name/class-name*/
...
/*can-util@3.0.0-pre.15#dom/contains/contains*/
define('can-util/dom/contains/contains', function (require, exports, module) {
    module.exports = function (child) {
        return this.contains(child);
    };
});
/*can-util@3.0.0-pre.15#dom/fragment/fragment*/
...
/*can-util@3.0.0-pre.15#dom/frag/frag*/
...
/*can-util@3.0.0-pre.15#dom/matches/matches*/
...
/*can-util@3.0.0-pre.15#dom/mutate/mutate*/
...
/*can-util@3.0.0-pre.15#js/cid/cid*/
...
/*can-util@3.0.0-pre.15#js/diff/diff*/
...
/*can-util@3.0.0-pre.15#js/import/import*/
...
/*can-util@3.0.0-pre.15#js/is-browser-window/is-browser-window*/
...
/*can-util@3.0.0-pre.15#js/is-string/is-string*/
...
/*can-util@3.0.0-pre.15#js/join-uris/join-uris*/
...
/*can-util@3.0.0-pre.15#js/last/last*/
define('can-util/js/last/last', function (require, exports, module) {
    module.exports = function (arr) {
        return arr && arr[arr.length - 1];
    };
});
/*can-util@3.0.0-pre.15#js/string/string*/
...
/*can-util@3.0.0-pre.15#can-util*/
