...
/*can-util@3.0.0-pre.2#js/is-array/is-array*/
define('can-util/js/is-array/is-array', function (require, exports, module) {
    module.exports = function (arr) {
        return Array.isArray(arr);
    };
});
/*can-util@3.0.0-pre.2#js/is-function/is-function*/
...
/*can-util@3.0.0-pre.2#js/is-plain-object/is-plain-object*/
...
/*can-util@3.0.0-pre.2#js/deep-extend/deep-extend*/
...
/*can-util@3.0.0-pre.2#dom/is-of-global-document/is-of-global-document*/
...
/*can-util@3.0.0-pre.2#dom/data/data*/
...
/*can-util@3.0.0-pre.2#js/assign/assign*/
...
/*can-util@3.0.0-pre.2#dom/dispatch/dispatch*/
...
/*can-util@3.0.0-pre.2#dom/events/events*/
...
/*can-util@3.0.0-pre.2#dom/mutation-observer/mutation-observer*/
...
/*can-util@3.0.0-pre.2#dom/events/attributes/attributes*/
...
/*can-util@3.0.0-pre.2#dom/attr/attr*/
...
/*can-util@3.0.0-pre.2#dom/class-name/class-name*/
...
/*can-util@3.0.0-pre.2#dom/contains/contains*/
...
/*can-util@3.0.0-pre.2#dom/fragment/fragment*/
...
/*can-util@3.0.0-pre.2#dom/matches/matches*/
...
/*can-util@3.0.0-pre.2#js/is-array-like/is-array-like*/
...
/*can-util@3.0.0-pre.2#js/each/each*/
...
/*can-util@3.0.0-pre.2#js/make-array/make-array*/
...
/*can-util@3.0.0-pre.2#dom/mutate/mutate*/
...
/*can-util@3.0.0-pre.2#js/cid/cid*/
...
/*can-util@3.0.0-pre.2#js/dev/dev*/
define('can-util/js/dev/dev', function (require, exports, module) {
});
/*can-util@3.0.0-pre.2#js/diff/diff*/
...
/*can-util@3.0.0-pre.2#js/is-browser-window/is-browser-window*/
...
/*can-util@3.0.0-pre.2#js/is-promise/is-promise*/
...
/*can-util@3.0.0-pre.2#js/is-string/is-string*/
...
/*can-util@3.0.0-pre.2#js/join-uris/join-uris*/
...
/*can-util@3.0.0-pre.2#js/last/last*/
define('can-util/js/last/last', function (require, exports, module) {
    module.exports = function (arr) {
        return arr && arr[arr.length - 1];
    };
});
/*can-util@3.0.0-pre.2#js/string/string*/
