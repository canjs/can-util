...
/*can-util@3.0.0-pre.24#js/is-array/is-array*/
define('can-util/js/is-array/is-array', function (require, exports, module) {
    module.exports = function (arr) {
        return Array.isArray(arr);
    };
});
/*can-util@3.0.0-pre.24#js/is-function/is-function*/
...
/*can-util@3.0.0-pre.24#js/is-plain-object/is-plain-object*/
...
/*can-util@3.0.0-pre.24#js/deep-extend/deep-extend*/
...
/*can-util@3.0.0-pre.24#namespace*/
...
/*can-util@3.0.0-pre.24#dom/document/document*/
...
/*can-util@3.0.0-pre.24#dom/is-of-global-document/is-of-global-document*/
...
/*can-util@3.0.0-pre.24#js/is-empty-object/is-empty-object*/
...
/*can-util@3.0.0-pre.24#dom/data/data*/
...
/*can-util@3.0.0-pre.24#js/assign/assign*/
...
/*can-util@3.0.0-pre.24#dom/dispatch/dispatch*/
...
/*can-util@3.0.0-pre.24#dom/mutation-observer/mutation-observer*/
...
/*can-util@3.0.0-pre.24#dom/events/events*/
...
/*can-util@3.0.0-pre.24#dom/events/attributes/attributes*/
...
/*can-util@3.0.0-pre.24#dom/attr/attr*/
...
/*can-util@3.0.0-pre.24#dom/child-nodes/child-nodes*/
...
/*can-util@3.0.0-pre.24#dom/class-name/class-name*/
...
/*can-util@3.0.0-pre.24#dom/contains/contains*/
define('can-util/dom/contains/contains', function (require, exports, module) {
    module.exports = function (child) {
        return this.contains(child);
    };
});
/*can-util@3.0.0-pre.24#dom/fragment/fragment*/
...
/*can-util@3.0.0-pre.24#js/is-array-like/is-array-like*/
...
/*can-util@3.0.0-pre.24#js/each/each*/
...
/*can-util@3.0.0-pre.24#dom/frag/frag*/
...
/*can-util@3.0.0-pre.24#dom/matches/matches*/
...
/*can-util@3.0.0-pre.24#js/make-array/make-array*/
...
/*can-util@3.0.0-pre.24#js/cid/cid*/
...
/*can-util@3.0.0-pre.24#dom/mutate/mutate*/
define('can-util/dom/mutate/mutate', function (require, exports, module) {
    ...
    var domDispatch = require('can-util/dom/dispatch/dispatch');
    var canNamespace = require('can-util/namespace');
    var mutatedElements;
    var checks = {
...
/*can-util@3.0.0-pre.24#js/dev/dev*/
define('can-util/js/dev/dev', function (require, exports, module) {
});
/*can-util@3.0.0-pre.24#js/diff/diff*/
...
/*can-util@3.0.0-pre.24#js/import/import*/
...
/*can-util@3.0.0-pre.24#js/is-browser-window/is-browser-window*/
...
/*can-util@3.0.0-pre.24#js/is-node/is-node*/
define('can-util/js/is-node/is-node', function (require, exports, module) {
    module.exports = function () {
        return typeof process === 'object' && {}.toString.call(process) === '[object process]';
    };
});
/*can-util@3.0.0-pre.24#js/is-promise/is-promise*/
...
/*can-util@3.0.0-pre.24#js/is-string/is-string*/
...
/*can-util@3.0.0-pre.24#js/is-web-worker/is-web-worker*/
define('can-util/js/is-web-worker/is-web-worker', function (require, exports, module) {
    module.exports = function () {
        return typeof WorkerGlobalScope !== 'undefined' && this instanceof WorkerGlobalScope;
    };
});
/*can-util@3.0.0-pre.24#js/join-uris/join-uris*/
...
/*can-util@3.0.0-pre.24#js/last/last*/
define('can-util/js/last/last', function (require, exports, module) {
    module.exports = function (arr) {
        return arr && arr[arr.length - 1];
    };
});
/*can-util@3.0.0-pre.24#js/string/string*/
...
/*can-util@3.0.0-pre.24#js/types/types*/
