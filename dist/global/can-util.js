...
/*can-util@3.0.0-pre.0#js/is-array/is-array*/
define('can-util/js/is-array/is-array', function (require, exports, module) {
    module.exports = function (arr) {
        return Array.isArray(arr);
    };
});
/*can-util@3.0.0-pre.0#js/is-function/is-function*/
...
/*can-util@3.0.0-pre.0#js/is-plain-object/is-plain-object*/
...
/*can-util@3.0.0-pre.0#js/global/global*/
...
/*can-util@3.0.0-pre.0#js/set-immediate/set-immediate*/
...
/*can-util@3.0.0-pre.0#dom/document/document*/
...
/*can-util@3.0.0-pre.0#dom/data/data*/
...
/*can-util@3.0.0-pre.0#dom/dispatch/dispatch*/
...
/*can-util@3.0.0-pre.0#dom/events/events*/
...
/*can-util@3.0.0-pre.0#dom/mutation-observer/mutation-observer*/
...
/*can-util@3.0.0-pre.0#dom/events/attributes/attributes*/
...
/*can-util@3.0.0-pre.0#dom/attr/attr*/
...
/*can-util@3.0.0-pre.0#dom/child-nodes/child-nodes*/
...
/*can-util@3.0.0-pre.0#dom/class-name/class-name*/
...
/*can-util@3.0.0-pre.0#dom/fragment/fragment*/
...
/*can-util@3.0.0-pre.0#dom/matches/matches*/
...
/*can-util@3.0.0-pre.0#js/each/each*/
...
/*can-util@3.0.0-pre.0#js/make-array/make-array*/
...
/*can-util@3.0.0-pre.0#dom/mutate/mutate*/
...
/*can-util@3.0.0-pre.0#js/cid/cid*/
...
/*can-util@3.0.0-pre.0#js/dev/dev*/
define('can-util/js/dev/dev', function (require, exports, module) {
});
/*can-util@3.0.0-pre.0#js/diff/diff*/
...
/*can-util@3.0.0-pre.0#js/import/import*/
...
/*can-util@3.0.0-pre.0#js/is-browser-window/is-browser-window*/
...
/*can-util@3.0.0-pre.0#js/is-string/is-string*/
...
/*can-util@3.0.0-pre.0#js/join-uris/join-uris*/
...
/*can-util@3.0.0-pre.0#js/last/last*/
define('can-util/js/last/last', function (require, exports, module) {
    module.exports = function (arr) {
        return arr && arr[arr.length - 1];
    };
});
/*can-util@3.0.0-pre.0#js/string/string*/
...
/*can-util@3.0.0-pre.0#js/types/types*/
...
define('can-util/js/js', function (require, exports, module) {
    module.exports = {
        ...
        each: require('can-util/js/diff/diff'),
