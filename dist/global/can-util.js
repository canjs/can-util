...
/*can-util@3.0.0-pre.5#js/is-array/is-array*/
define('can-util/js/is-array/is-array', function (require, exports, module) {
    module.exports = function (arr) {
        return Array.isArray(arr);
    };
});
/*can-util@3.0.0-pre.5#js/is-function/is-function*/
...
/*can-util@3.0.0-pre.5#js/is-plain-object/is-plain-object*/
...
/*can-util@3.0.0-pre.5#js/deep-extend/deep-extend*/
...
/*can-util@3.0.0-pre.5#js/global/global*/
...
/*can-util@3.0.0-pre.5#dom/document/document*/
...
/*can-util@3.0.0-pre.5#dom/is-of-global-document/is-of-global-document*/
...
/*can-util@3.0.0-pre.5#js/is-empty-object/is-empty-object*/
...
/*can-util@3.0.0-pre.5#dom/data/data*/
...
/*can-util@3.0.0-pre.5#js/assign/assign*/
...
/*can-util@3.0.0-pre.5#dom/dispatch/dispatch*/
...
/*can-util@3.0.0-pre.5#dom/mutation-observer/mutation-observer*/
...
/*can-util@3.0.0-pre.5#dom/events/attributes/attributes*/
...
/*can-util@3.0.0-pre.5#dom/attr/attr*/
...
/*can-util@3.0.0-pre.5#dom/child-nodes/child-nodes*/
...
/*can-util@3.0.0-pre.5#dom/class-name/class-name*/
...
/*can-util@3.0.0-pre.5#dom/contains/contains*/
define('can-util/dom/contains/contains', function (require, exports, module) {
    module.exports = function (child) {
        return this.contains(child);
    };
});
/*can-util@3.0.0-pre.5#dom/fragment/fragment*/
...
/*can-util@3.0.0-pre.5#js/is-array-like/is-array-like*/
...
/*can-util@3.0.0-pre.5#js/each/each*/
...
/*can-util@3.0.0-pre.5#dom/frag/frag*/
...
/*can-util@3.0.0-pre.5#dom/matches/matches*/
...
/*can-util@3.0.0-pre.5#js/make-array/make-array*/
...
/*can-util@3.0.0-pre.5#dom/mutate/mutate*/
...
/*can-util@3.0.0-pre.5#js/cid/cid*/
...
/*can-util@3.0.0-pre.5#js/dev/dev*/
define('can-util/js/dev/dev', function (require, exports, module) {
});
/*can-util@3.0.0-pre.5#js/diff/diff*/
...
/*can-util@3.0.0-pre.5#js/import/import*/
...
/*can-util@3.0.0-pre.5#js/is-browser-window/is-browser-window*/
...
/*can-util@3.0.0-pre.5#js/is-node/is-node*/
define('can-util/js/is-node/is-node', function (require, exports, module) {
    module.exports = function () {
        return typeof process === 'object' && {}.toString.call(process) === '[object process]';
    };
});
/*can-util@3.0.0-pre.5#js/is-promise/is-promise*/
...
/*can-util@3.0.0-pre.5#js/is-string/is-string*/
...
/*can-util@3.0.0-pre.5#js/join-uris/join-uris*/
...
/*can-util@3.0.0-pre.5#js/last/last*/
define('can-util/js/last/last', function (require, exports, module) {
    module.exports = function (arr) {
        return arr && arr[arr.length - 1];
    };
});
/*can-util@3.0.0-pre.5#js/string/string*/
