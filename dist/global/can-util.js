...
/*can-util@3.0.0-pre.42#js/is-array/is-array*/
define('can-util/js/is-array/is-array', function (require, exports, module) {
    module.exports = function (arr) {
        return Array.isArray(arr);
    };
});
/*can-util@3.0.0-pre.42#js/is-function/is-function*/
...
/*can-util@3.0.0-pre.42#js/is-plain-object/is-plain-object*/
...
/*can-util@3.0.0-pre.42#js/deep-assign/deep-assign*/
...
/*can-util@3.0.0-pre.42#namespace*/
define('can-util/namespace', function (require, exports, module) {
    module.exports = {};
});
/*can-util@3.0.0-pre.42#js/assign/assign*/
...
/*can-util@3.0.0-pre.42#dom/ajax/ajax*/
...
/*can-util@3.0.0-pre.42#js/global/global*/
...
/*can-util@3.0.0-pre.42#js/set-immediate/set-immediate*/
...
/*can-util@3.0.0-pre.42#dom/document/document*/
...
/*can-util@3.0.0-pre.42#dom/is-of-global-document/is-of-global-document*/
...
/*can-util@3.0.0-pre.42#js/is-empty-object/is-empty-object*/
...
/*can-util@3.0.0-pre.42#dom/data/data*/
...
/*can-util@3.0.0-pre.42#dom/events/events*/
...
/*can-util@3.0.0-pre.42#dom/dispatch/dispatch*/
...
/*can-util@3.0.0-pre.42#dom/mutation-observer/mutation-observer*/
...
/*can-util@3.0.0-pre.42#js/is-array-like/is-array-like*/
...
/*can-util@3.0.0-pre.42#js/is-iterable/is-iterable*/
...
/*can-util@3.0.0-pre.42#js/each/each*/
...
/*can-util@3.0.0-pre.42#dom/events/attributes/attributes*/
...
/*can-util@3.0.0-pre.42#dom/child-nodes/child-nodes*/
...
/*can-util@3.0.0-pre.42#dom/class-name/class-name*/
...
/*can-util@3.0.0-pre.42#dom/contains/contains*/
define('can-util/dom/contains/contains', function (require, exports, module) {
    module.exports = function (child) {
        return this.contains(child);
    };
});
/*can-util@3.0.0-pre.42#dom/fragment/fragment*/
...
/*can-util@3.0.0-pre.42#dom/frag/frag*/
...
/*can-util@3.0.0-pre.42#dom/matches/matches*/
...
/*can-util@3.0.0-pre.42#js/make-array/make-array*/
...
/*can-util@3.0.0-pre.42#js/cid/cid*/
...
/*can-util@3.0.0-pre.42#dom/mutate/mutate*/
...
/*can-util@3.0.0-pre.42#js/dev/dev*/
define('can-util/js/dev/dev', function (require, exports, module) {
});
/*can-util@3.0.0-pre.42#js/diff/diff*/
...
/*can-util@3.0.0-pre.42#js/import/import*/
...
/*can-util@3.0.0-pre.42#js/is-browser-window/is-browser-window*/
...
/*can-util@3.0.0-pre.42#js/is-node/is-node*/
...
/*can-util@3.0.0-pre.42#js/is-string/is-string*/
define('can-util/js/is-string/is-string', function (require, exports, module) {
    module.exports = function isString(obj) {
        return typeof obj === 'string';
    };
});
/*can-util@3.0.0-pre.42#js/is-web-worker/is-web-worker*/
...
/*can-util@3.0.0-pre.42#js/join-uris/join-uris*/
...
/*can-util@3.0.0-pre.42#js/last/last*/
define('can-util/js/last/last', function (require, exports, module) {
    module.exports = function (arr) {
        return arr && arr[arr.length - 1];
    };
});
/*can-util@3.0.0-pre.42#js/string/string*/
...
/*can-util@3.0.0-pre.42#can-util*/
