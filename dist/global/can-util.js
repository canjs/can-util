...
/*can-util@3.0.0-pre.67#js/global/global*/
...
/*can-util@3.0.0-pre.67#js/parse-uri/parse-uri*/
...
/*can-util@3.0.0-pre.67#dom/ajax/ajax*/
...
/*can-util@3.0.0-pre.67#js/set-immediate/set-immediate*/
...
/*can-util@3.0.0-pre.67#dom/document/document*/
...
/*can-util@3.0.0-pre.67#dom/is-of-global-document/is-of-global-document*/
...
/*can-util@3.0.0-pre.67#js/is-empty-object/is-empty-object*/
...
/*can-util@3.0.0-pre.67#dom/data/data*/
...
/*can-util@3.0.0-pre.67#dom/contains/contains*/
define('can-util/dom/contains/contains', function (require, exports, module) {
    module.exports = function (child) {
        return this.contains(child);
    };
});
/*can-util@3.0.0-pre.67#dom/events/events*/
...
/*can-util@3.0.0-pre.67#dom/dispatch/dispatch*/
...
/*can-util@3.0.0-pre.67#dom/mutation-observer/mutation-observer*/
...
/*can-util@3.0.0-pre.67#dom/events/attributes/attributes*/
...
/*can-util@3.0.0-pre.67#dom/attr/attr*/
...
/*can-util@3.0.0-pre.67#dom/child-nodes/child-nodes*/
...
/*can-util@3.0.0-pre.67#dom/class-name/class-name*/
...
/*can-util@3.0.0-pre.67#dom/fragment/fragment*/
...
/*can-util@3.0.0-pre.67#dom/frag/frag*/
...
/*can-util@3.0.0-pre.67#dom/matches/matches*/
...
/*can-util@3.0.0-pre.67#js/cid/cid*/
...
/*can-util@3.0.0-pre.67#dom/mutate/mutate*/
...
/*can-util@3.0.0-pre.67#js/diff/diff*/
...
/*can-util@3.0.0-pre.67#js/import/import*/
...
/*can-util@3.0.0-pre.67#js/is-browser-window/is-browser-window*/
...
/*can-util@3.0.0-pre.67#js/is-node/is-node*/
...
/*can-util@3.0.0-pre.67#js/is-string/is-string*/
define('can-util/js/is-string/is-string', function (require, exports, module) {
    module.exports = function isString(obj) {
        return typeof obj === 'string';
    };
});
/*can-util@3.0.0-pre.67#js/is-web-worker/is-web-worker*/
...
/*can-util@3.0.0-pre.67#js/join-uris/join-uris*/
...
/*can-util@3.0.0-pre.67#js/last/last*/
define('can-util/js/last/last', function (require, exports, module) {
    module.exports = function (arr) {
        return arr && arr[arr.length - 1];
    };
});
/*can-util@3.0.0-pre.67#js/string/string*/
...
/*can-util@3.0.0-pre.67#can-util*/
