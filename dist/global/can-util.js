...
/*can-util@3.0.0-pre.56#dom/ajax/ajax*/
...
/*can-util@3.0.0-pre.56#dom/is-of-global-document/is-of-global-document*/
...
/*can-util@3.0.0-pre.56#dom/mutation-observer/mutation-observer*/
...
/*can-util@3.0.0-pre.56#dom/events/attributes/attributes*/
...
/*can-util@3.0.0-pre.56#dom/attr/attr*/
...
/*can-util@3.0.0-pre.56#dom/child-nodes/child-nodes*/
...
/*can-util@3.0.0-pre.56#dom/contains/contains*/
define('can-util/dom/contains/contains', function (require, exports, module) {
    module.exports = function (child) {
        return this.contains(child);
    };
});
/*can-util@3.0.0-pre.56#dom/fragment/fragment*/
...
/*can-util@3.0.0-pre.56#dom/frag/frag*/
...
/*can-util@3.0.0-pre.56#dom/mutate/mutate*/
...
/*can-util@3.0.0-pre.56#js/diff/diff*/
...
/*can-util@3.0.0-pre.56#js/import/import*/
...
/*can-util@3.0.0-pre.56#js/is-browser-window/is-browser-window*/
...
/*can-util@3.0.0-pre.56#js/is-node/is-node*/
...
/*can-util@3.0.0-pre.56#js/is-string/is-string*/
define('can-util/js/is-string/is-string', function (require, exports, module) {
    module.exports = function isString(obj) {
        return typeof obj === 'string';
    };
});
/*can-util@3.0.0-pre.56#js/is-web-worker/is-web-worker*/
...
/*can-util@3.0.0-pre.56#js/join-uris/join-uris*/
...
/*can-util@3.0.0-pre.56#can-util*/
