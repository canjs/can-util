...
/*can-util@3.0.0-pre.40#js/is-array/is-array*/
define('can-util/js/is-array/is-array', function (require, exports, module) {
    module.exports = function (arr) {
        return Array.isArray(arr);
    };
});
/*can-util@3.0.0-pre.40#js/is-function/is-function*/
...
/*can-util@3.0.0-pre.40#js/is-plain-object/is-plain-object*/
...
/*can-util@3.0.0-pre.40#js/deep-assign/deep-assign*/
...
/*can-util@3.0.0-pre.40#namespace*/
define('can-util/namespace', function (require, exports, module) {
    module.exports = {};
});
/*can-util@3.0.0-pre.40#js/assign/assign*/
...
/*can-util@3.0.0-pre.40#dom/ajax/ajax*/
...
/*can-util@3.0.0-pre.40#js/global/global*/
...
/*can-util@3.0.0-pre.40#js/set-immediate/set-immediate*/
...
/*can-util@3.0.0-pre.40#dom/document/document*/
...
/*can-util@3.0.0-pre.40#dom/is-of-global-document/is-of-global-document*/
...
/*can-util@3.0.0-pre.40#js/is-empty-object/is-empty-object*/
...
/*can-util@3.0.0-pre.40#dom/data/data*/
...
/*can-util@3.0.0-pre.40#dom/events/events*/
...
/*can-util@3.0.0-pre.40#dom/dispatch/dispatch*/
...
/*can-util@3.0.0-pre.40#dom/mutation-observer/mutation-observer*/
...
/*can-util@3.0.0-pre.40#js/is-array-like/is-array-like*/
...
/*can-util@3.0.0-pre.40#js/is-iterable/is-iterable*/
...
/*can-util@3.0.0-pre.40#js/each/each*/
...
/*can-util@3.0.0-pre.40#dom/events/attributes/attributes*/
...
/*can-util@3.0.0-pre.40#dom/attr/attr*/
...
/*can-util@3.0.0-pre.40#dom/child-nodes/child-nodes*/
...
/*can-util@3.0.0-pre.40#dom/class-name/class-name*/
...
/*can-util@3.0.0-pre.40#dom/contains/contains*/
define('can-util/dom/contains/contains', function (require, exports, module) {
    module.exports = function (child) {
        return this.contains(child);
    };
});
/*can-util@3.0.0-pre.40#dom/fragment/fragment*/
...
/*can-util@3.0.0-pre.40#dom/frag/frag*/
...
/*can-util@3.0.0-pre.40#dom/matches/matches*/
...
/*can-util@3.0.0-pre.40#js/make-array/make-array*/
...
/*can-util@3.0.0-pre.40#js/cid/cid*/
...
/*can-util@3.0.0-pre.40#dom/mutate/mutate*/
...
/*can-util@3.0.0-pre.40#js/dev/dev*/
define('can-util/js/dev/dev', function (require, exports, module) {
});
/*can-util@3.0.0-pre.40#js/diff/diff*/
...
/*can-util@3.0.0-pre.40#js/import/import*/
...
/*can-util@3.0.0-pre.40#js/is-browser-window/is-browser-window*/
...
/*can-util@3.0.0-pre.40#js/is-node/is-node*/
...
/*can-util@3.0.0-pre.40#js/is-string/is-string*/
...
/*can-util@3.0.0-pre.40#js/join-uris/join-uris*/
...
/*can-util@3.0.0-pre.40#js/last/last*/
define('can-util/js/last/last', function (require, exports, module) {
    module.exports = function (arr) {
        return arr && arr[arr.length - 1];
    };
});
/*can-util@3.0.0-pre.40#js/string/string*/
...
/*can-util@3.0.0-pre.40#can-util*/
